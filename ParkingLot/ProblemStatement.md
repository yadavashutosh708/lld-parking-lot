...
Main Agenda:
1. Automated Parking Lot with Ticketing system
2. Inputs: Registration Number, Colour and type of vehicle
3. Output: Parking Slot allocation, Tickets, Rent Charged => Number of hours
...
1. 2. Focus on the main parts first - create parking lot, park, unpark first. (if time permits, focus on other features). 
2. 3. Try to do draw a small uml diagram, list the entities and the relationship. 
3. 4. now try to build the logic for the above 3 features. 
4. 5. In case you have multiple vehicles - car, bike, truck (use Factory design pattern easy to implement). 
5. 6. for parking lot creation use singleton as well.** it's good if you can get till here ** 
6. 7. Use Treeset for making sure the ordering works. (do check its complexity though).
1. 8. Finally bonus, see if you can handle threading here.